...
BEGIN
  EXECUTE IMMEDIATE 'DROP SEQUENCE mgs_category_id_seq';
  EXECUTE IMMEDIATE 'DROP SEQUENCE mgs_product_id_seq';
  EXECUTE IMMEDIATE 'DROP SEQUENCE mgs_customer_id_seq';
  EXECUTE IMMEDIATE 'DROP SEQUENCE mgs_address_id_seq';
  EXECUTE IMMEDIATE 'DROP SEQUENCE mgs_order_id_seq';
  EXECUTE IMMEDIATE 'DROP SEQUENCE mgs_item_id_seq';
  EXECUTE IMMEDIATE 'DROP SEQUENCE mgs_admin_id_seq';

  EXECUTE IMMEDIATE 'DROP TABLE mgs_administrators';
  EXECUTE IMMEDIATE 'DROP TABLE mgs_order_items';
  EXECUTE IMMEDIATE 'DROP TABLE mgs_orders';
  EXECUTE IMMEDIATE 'DROP TABLE mgs_products';
  EXECUTE IMMEDIATE 'DROP TABLE mgs_categories';
  EXECUTE IMMEDIATE 'DROP TABLE mgs_addresses';
  EXECUTE IMMEDIATE 'DROP TABLE mgs_customers';
EXCEPTION
  WHEN OTHERS THEN
...
-- Create the tables
CREATE TABLE mgs_categories (
  category_id        NUMBER         PRIMARY KEY,
  category_name      VARCHAR2(255)  NOT NULL      UNIQUE
);

CREATE TABLE mgs_products (
  product_id         NUMBER         PRIMARY KEY,
  category_id        NUMBER         REFERENCES mgs_categories (category_id),
...
CREATE TABLE mgs_addresses (
  address_id         NUMBER          PRIMARY KEY,
  customer_id        NUMBER          REFERENCES mgs_customers (customer_id),
...
CREATE TABLE mgs_order_items (
  item_id            NUMBER         PRIMARY KEY,
  order_id           NUMBER         REFERENCES mgs_orders (order_id),
  product_id         NUMBER         REFERENCES mgs_products (product_id),
  item_price         NUMBER(10,2)   NOT NULL,
  discount_amount    NUMBER(10,2)   NOT NULL,
  quantity           NUMBER         NOT NULL
);

CREATE TABLE mgs_administrators (
...
INSERT INTO mgs_categories (category_id, category_name) VALUES
(1, 'Guitars');
INSERT INTO mgs_categories (category_id, category_name) VALUES
(2, 'Basses');
INSERT INTO mgs_categories (category_id, category_name) VALUES
...
CREATE SEQUENCE mgs_category_id_seq
  START WITH 5;

INSERT INTO mgs_products (product_id, category_id, product_code, product_name, description, list_price, discount_percent, date_added) VALUES
...
CREATE SEQUENCE mgs_product_id_seq
  START WITH 11;
  
INSERT INTO mgs_customers (customer_id, email_address, password, first_name, last_name, shipping_address_id, billing_address_id) VALUES
...
CREATE SEQUENCE mgs_customer_id_seq
  START WITH 9;

INSERT INTO mgs_addresses (address_id, customer_id, line1, line2, city, state, zip_code, phone, disabled) VALUES
...
CREATE SEQUENCE mgs_address_id_seq
  START WITH 13;
  
INSERT INTO mgs_orders (order_id, customer_id, order_date, ship_amount, tax_amount, ship_date, ship_address_id, card_type, card_number, card_expires, billing_address_id) VALUES
...
CREATE SEQUENCE mgs_order_id_seq
  START WITH 10;
  
INSERT INTO mgs_order_items (item_id, order_id, product_id, item_price, discount_amount, quantity) VALUES
...
CREATE SEQUENCE mgs_item_id_seq
  START WITH 13;
  
INSERT INTO mgs_administrators (admin_id, email_address, password, first_name, last_name) VALUES
...
CREATE SEQUENCE mgs_admin_id_seq
  START WITH 13;
